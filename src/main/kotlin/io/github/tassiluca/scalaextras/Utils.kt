...
internal fun Project.resolveOrFromResource(filename: String): String = resolveOr(filename) { resource(filename) }

internal fun Project.resolveOrElse(filename: String, orElse: String): String = resolveOr(filename) { orElse }
